...
def query_2s(entity_embeddings: nn.Module,
             predicate_embeddings: nn.Module,
             queries: Tensor,
             scoring_function: Callable[[Tensor, Tensor, Tensor], Tensor],
             k: int,
    ...
    batch_size = p2_emb.shape[0]
    emb_size = p2_emb.shape[1]
    ...
    scores_2, _ = score_candidates(s_emb=x1_k_emb_2d, p_emb=p2_emb, candidates_emb=e_emb, k=None,
                                   entity_embeddings=entity_embeddings, scoring_function=scoring_function)
    scores_3, _ = score_candidates(s_emb=x1_k_emb_2d, p_emb=p3_emb, candidates_emb=e_emb, k=None,
                                   entity_embeddings=entity_embeddings, scoring_function=scoring_function)
    res = t_norm(scores_2, scores_3)
...
def query_3s(entity_embeddings: nn.Module,
             predicate_embeddings: nn.Module,
             queries: Tensor,
             scoring_function: Callable[[Tensor, Tensor, Tensor], Tensor],
             k: int,
    ...
    p2_emb = predicate_embeddings(queries[:,2])
    p3_emb = predicate_embeddings(queries[:,3])
    p4_emb = predicate_embeddings(queries[:,4])
    ...
    scores_3, _ = score_candidates(s_emb=x1_k_emb_2d, p_emb=p3_emb, candidates_emb=e_emb, k=None,
                                   entity_embeddings=entity_embeddings, scoring_function=scoring_function)
    scores_4, _ = score_candidates(s_emb=x1_k_emb_2d, p_emb=p4_emb, candidates_emb=e_emb, k=None,
                                   entity_embeddings=entity_embeddings, scoring_function=scoring_function)
...
def query_sp(entity_embeddings: nn.Module,
             predicate_embeddings: nn.Module,
             queries: Tensor,
             scoring_function: Callable[[Tensor, Tensor, Tensor], Tensor],
             k: int,
    ...
    ## 2s
    scores_1 = query_2s(entity_embeddings=entity_embeddings, predicate_embeddings=predicate_embeddings,
                        queries=queries[:, 0:4], scoring_function=scoring_function, k=k, t_norm=t_norm)
...
def query_is(entity_embeddings: nn.Module,
             predicate_embeddings: nn.Module,
             queries: Tensor,
             scoring_function: Callable[[Tensor, Tensor, Tensor], Tensor],
             k: int,
    ...
    ## split
    p_emb_1 = predicate_embeddings(queries[:,4])
    p_emb_2 = predicate_embeddings(queries[:,5])

    batch_size = p_emb_1.shape[0]
    emb_size = p_emb_1.shape[1]
    ...
    scores_2, _ = score_candidates(s_emb=scores_1_k_emb_2d, p_emb=p_emb_1, candidates_emb=e_emb, k=None,
                                   entity_embeddings=entity_embeddings, scoring_function=scoring_function)
    scores_3, _ = score_candidates(s_emb=scores_1_k_emb_2d, p_emb=p_emb_2, candidates_emb=e_emb, k=None,
                                   entity_embeddings=entity_embeddings, scoring_function=scoring_function)
    res = t_norm(scores_2, scores_3)
...
def query_us(entity_embeddings: nn.Module,
             predicate_embeddings: nn.Module,
             queries: Tensor,
             scoring_function: Callable[[Tensor, Tensor, Tensor], Tensor],
             k: int,
    ...
    ## split
    p_emb_1 = predicate_embeddings(queries[:,5])
    p_emb_2 = predicate_embeddings(queries[:,6])
