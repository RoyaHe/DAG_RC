...
--tree_data_path ./data/NELL-betae -n 128 -b 512 -d 800 -g 20 --geo cone \
--dag_data_path ./DAG-QA/data/NELL/Hard \
...
CUDA_VISIBLE_DEVICES=1 python3 main.py --cuda --do_test \
    --tree_data_path ./data/NELL-betae -n 128 -b 512 -d 800 -g 20 --geo cone \
    --dag_data_path ./DAG-QA/data/NELL/Easy \
    -lr 0.0001 --max_steps 300001 --cpu_num 0 --valid_steps 60000 --test_batch_size 4 \
    --seed 0 --drop 0.2 --tasks 2s.3s.sp.is.us.ins --checkpoint_path \
...
--tree_data_path ./data/FB15k-237-betae -n 128 -b 512 -d 800 -g 30 --geo cone \
--dag_data_path ./DAG-QA/data/FB15k-237/Hard \
...
CUDA_VISIBLE_DEVICES=2 python3 main.py --cuda --do_test \
    --tree_data_path ./data/FB15k-237-betae -n 128 -b 512 -d 800 -g 30 --geo cone \
    --dag_data_path ./DAG-QA/data/FB15k-237/Easy \
    -lr 0.00005 --max_steps 300001 --cpu_num 0 --valid_steps 30000 --test_batch_size 4 \
    --seed 0 --drop 0.1 --tasks 2s.3s.sp.is.us.ins --checkpoint_path \
...
--tree_data_path ./data/FB15k-betae -n 128 -b 512 -d 800 -g 40 --geo cone \
--dag_data_path ./DAG-QA/data/FB15k/Hard \
...
CUDA_VISIBLE_DEVICES=0 python3 main.py --do_test \
    ...
    --dag_data_path ./DAG-QA/data/FB15k/Easy -n 128 -b 512 -d 800 -g 40 --drop 0.05 \
    --cpu_num 0 --geo cone --valid_steps 15000 -lr 0.00005 --max_steps 450001 \
    --cuda --tasks 2s.3s.sp.is.us.ins --checkpoint_path  \
    
## test ConE * FB15k * Hard
CUDA_VISIBLE_DEVICES=0 python3 main.py --do_test \
    --tree_data_path ./data/FB15k-betae \
    --dag_data_path ./DAG-QA/data/FB15k/Hard -n 128 -b 512 -d 800 -g 40 --drop 0.05 \
    --cpu_num 0 --geo cone --valid_steps 15000 -lr 0.00005 --max_steps 450001 \
    --cuda --tasks 2s.3s.sp.is.us.ins --checkpoint_path  \
