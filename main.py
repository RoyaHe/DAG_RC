...
def load_data(args, tasks):
    ...
    train_queries, train_answers, alid_queries, valid_hard_answers, valid_easy_answers = defaultdict(set), defaultdict(set), defaultdict(set), defaultdict(set), defaultdict(set)
